        ...
        <div className="p-2">
          <div className="mb-4">
            <span className="text-2xl">
              Question{" "}
              {quizState.questions && quizState.currentQuestionIndex + 1}
            </span>
          ...
          <div className="">
            {!quizState.questions ? (
              <div className=" col-span-2 text-center justify-self-center">
                <Loading />
                We &apos;re restarting the app. Wait a second!
              </div>
            ) : (
              <div>
                {currentQuestion ? (
                  <div>{decodeURIComponent(currentQuestion.question)}</div>
                ) : null}
              </div>
            )}
          </div>
